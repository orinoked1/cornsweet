function inter = findintersection(L1,L2)
...
inter = [x,y];
if isnan(x)||isnan(y)||...
        (x<x1-ep&& x<x2-ep)||( x>x1+ep&& x>x2+ep )||(x<x3-ep&& x<x4-ep)||( x>x3+ep&& x>x4+ep)||...
        (y<y1-ep&& y<y2-ep)||( y>y1+ep&& y>y2+ep )||(y<y3-ep&& y<y4-ep)||( y>y3+ep&& y>y4+ep)
inter = inf ;
end
% figure 
% plot(L1(:,1),L1(:,2))
